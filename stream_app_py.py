...
def predict_accent(audio_path):
    ...
    # Mengambil aksen dengan probabilitas tertinggi
            ...
            with st.spinner("Processing audio..."):
                try:
                    ...
                    if not metadata_info.empty:
                        ...
                        st.markdown(f"<h2 style='color:#FF6347;'><i class='fas fa-map-marker-alt'></i> 📍Provinsii: {provinsi}</h2>", unsafe_allow_html=True)
